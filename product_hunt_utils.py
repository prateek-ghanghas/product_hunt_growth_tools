        ...
        try:
                ...
                for i in iterable:
                    ...
                    if "hideVotesCount" in i:
                        ...
                        maindic.update(dic)
                        product_launch_info_today.append(maindic)
        except KeyError:
                          pass

        return (product_launch_info_today)
...
def get_products_info(days: int)->list :
         ...
         return (product_launch_info + get_product_info_today())
...
def follow_persons_followers(person_username: str,followersFilePath: str)->bool :
    ...
    id_lst = get_followers(person_username)
...
def follow_persons_followings(person_username: str, followingsFilePath: str)->bool :
    ...
    id_lst = get_followings(person_username)
...
def follow_hunters_and_makers(days):

      prod_info = get_products_info(days)
      print(len(prod_info))

      id_list = []

      for dic in prod_info:
            for makers in dic["list_of_makers"]:
                  id_list.append(dic["list_of_makers"][makers])
      for i in id_list:
            follow_a_person(i)
